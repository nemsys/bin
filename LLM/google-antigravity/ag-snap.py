...
(function () {
  ...
  // 2. THOUGHT / AGENT (visible leading-relaxed blocks)
  ...
  for (const el of chatRoot.querySelectorAll(
    ...
    if (t && t.length > 2) addItem("tool_call", t, el, true);
  }

  // Sort by DOM document order — this is the single source of truth for ordering
  items.sort((a, b) => {
